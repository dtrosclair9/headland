      ...
      <div className="sheet">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 10 }}>
          <div>
            ...
            <h1 style={{ fontSize: 26, color: '#1A3D2E', fontWeight: 700, margin: '2px 0' }}>Selected blocks</h1>
        ...
        {svg ? (
          <svg viewBox={`0 0 ${svg.width} ${svg.height}`} style={{ width: '100%', height: 'auto', display: 'block' }}>
            {svg.blocks.map((b) => (
              <polygon
                key={b.id}
                points={b.points}
